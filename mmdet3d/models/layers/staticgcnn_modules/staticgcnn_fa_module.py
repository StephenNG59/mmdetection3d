...
class StaticGCNNFAModule(BaseModule):
    """Point feature aggregation module used in StaticGCNN.
    ...
    def __init__(self,
        ...
        super(StaticGCNNFAModule, self).__init__(init_cfg=init_cfg)
    ...
    def forward(self, points: List[Tensor]) -> Tensor:
        ...
        if len(points) > 1:
            ...
            new_fa_points = new_points.mean(
                dim=-1, keepdim=True)  # different to DGCNN
